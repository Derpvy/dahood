...
local Window = library:AddWindow("Nazi X", {
...
CreditTAB:AddButton("scripted by derpi#0001", function(bool)
    setclipboard("derpi is kool")
    wait(1)
    local function callback(text)
        if text == "Yes" then
        print("User said yes")
...
CreditTAB:AddButton("thx for ArcZangoatsu#0691 for the script name", function(bool)
    setclipboard("https://discord.gg/pFYjFFdwUs")
    wait(1)
    local function callback(text)
        if text == "Yes" then
        print("User said yes")
